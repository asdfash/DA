...
const UMS = ({ notify }) => {
      ...
      .catch(err => {
        switch (err.response.status) {
          ...
          case 403:
            ...
            break;
          default:
            setGroupError("* " + err.response.data);
            updateInfo(!updateBool);
        }
      });
  };
  ...
  const handleCreate = e => {
    e.preventDefault();
    setCreateUser({ ...createUser, error: "" });
      ...
      .catch(err => {
        switch (err.response.status) {
          ...
          case 403:
            ...
            break;
          default:
            setCreateUser({ ...createUser, error: "*" + err.response.data });
            updateInfo(!updateBool);
        }
      });
  };
      ...
      .catch(err => {
        switch (err.response.status) {
          ...
          case 403:
            ...
            break;
          default:
            setEditUser({ ...editUser, error: "*" + err.response.data });
        }
      });
  };
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <div className="error">{createUser.error}</div>
            </td>
          </tr>
          {/* edit user */}
          {users.map(user => (
              ...
              {editUser.username === user.username ? (
                <>
                  ...
                  <td>
                    ...
                    <div className="error">{editUser.error}</div>
                  </td>
                </>
              ) : (
                // view only
